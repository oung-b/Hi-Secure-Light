                            ...
                            <div>
                                ...
                                <div class="account-form row-group">
                                    ...
                                    <div class="form-item row-group">
                                        ...
                                        <input type="text" class="form-input" name="firmware">
                                    </div>
                                    <div class="form-item row-group">
                                        <p class="item-title">
                                            Application S/W Ver.
                                        </p>
                                        <input type="text" class="form-input" name="application">
                                    </div>
                                    <div class="form-item row-group">
                                        <p class="item-title">
                                            Patch Level
                                        </p>
                                        <input type="text" class="form-input" name="patch_level">
                                    </div>
                                    <div class="form-item row-group">
                                        <p class="item-title">
                                            Purpose
                                        </p>
                                        <input type="text" class="form-input" name="purpose">
                                    </div>
                                </div>
                                {{--                            </form>--}}
                            </div>
    ...
    <div class="modal-wrap modal-alert-wrap">
        ...
        <div class="modal-alert-title-wrap">
            ...
            <p class="modal-alert-title">
                Software creation has been completed.
            </p>
        </div>
...
<script>
    document.getElementById('submit').addEventListener('click', function () {
        ...
        fetchUtility("{{ route('software.store') }}", formData, true);
    });
</script>
</body>
</html>
