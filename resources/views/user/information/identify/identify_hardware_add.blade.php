                                ...
                                <div class="account-form row-group">
                                    ...
                                    <div class="form-item-group col-group">
                                        <div class="form-item row-group">
                                            ...
                                            <input type="text" class="form-input" name="q_type">
                                        </div>
                                        <div class="form-item row-group">
                                            <p class="item-title">
                                                Ver.
                                        ...
                                        <div class="form-item row-group">
                                            ...
                                            <input type="text" class="form-input" name="rj45">
                                        </div>
                                        <div class="form-item row-group">
                                            <p class="item-title">
                                                USB
                                            </p>
                                            <input type="text" class="form-input" name="usb">
                                        </div>
                                        <div class="form-item row-group">
                                            <p class="item-title">
                                                Serial
    ...
    <div class="modal-wrap modal-alert-wrap">
        ...
        <div class="modal-alert-title-wrap">
            ...
            <p class="modal-alert-title">
                Hardware creation has been completed.
            </p>
        </div>
