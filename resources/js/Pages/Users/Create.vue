<template>
    <div class="register subContent">
        <form @submit.prevent="register">
            <div class="wrap-auth">
                <h3 class="title">회원가입</h3>

                <input-verify-number v-if="!form.contact" @verified="(data) => this.form.contact = data" />

                <div class="m-input-wrap type01" v-if="form.contact">
                    ...
                    <input-verify-number @verified="(data) => {form.contact = data;}" v-else />
...
사. 개인정보관련 기술적-관리적 대책
회사는 이용자들의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 유출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적 대책을 강구하고 있습니다.
...
회사는 해킹이나 컴퓨터 바이러스 등에 의해 회원의 개인정보가 유출되거나 훼손되는 것을 막기 위해 최선을 다하고 있습니다. 개인정보의 훼손에 대비해서 자료를 수시로 백업하고 있고, 최신 백신프로그램을 이용하여 이용자들의 개인정보나 자료가 유출되거나 손상되지 않도록 방지하고 있으며, 암호알고리즘 등을 통하여 네트워크상에서 개인정보를 안전하게 전송할 수 있도록 하고 있습니다. 그리고 침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있으며, 기타 시스템적으로 안정성을 확보하기 위한 가능한 모든 기술적 장치를 갖추려 노력하고 있습니다.
                ...
                <div class="m-input-checkboxes type02 mt-10">
                    ...
                    <div class="m-input-error">{{ form.errors.agree_privacy }}</div>
                </div>
                ...
                <div class="btns mt-40">
                    <button class="m-btn type04">회원가입</button>
                </div>
            </div>
        </form>
    </div>
...
export default {
    components: {Link, InputVerifyNumber},
    data(){
        return {
